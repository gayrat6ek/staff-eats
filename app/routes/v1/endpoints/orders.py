...
async def read_orders(
    ...
    query = order_crud.get_orders(db=db, id=id, order_date=created_at, company_id=company, department_id=department_id, from_date=from_date, to_date=to_date, department_name=department_name)
